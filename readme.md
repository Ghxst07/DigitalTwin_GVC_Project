...
* [cite_start]**Warping & Blending:** Warped images into a Cylindrical/Equirectangular projection and blended seams to create a continuous panorama[cite: 1, 6].
...
[cite_start]Per the project guidelines[cite: 5, 17], specific project parameters are procedurally controlled by my Roll Number.
...
## [cite_start]4. GVC Concepts Applied [cite: 4]
...
## [cite_start]5. Tools & External Libraries [cite: 6]
